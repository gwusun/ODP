...
function BrowserRuntime() {
    ...
    function readFileSync(path, encoding) {
        if(debug){
            path=webServer+"/StudyJava/webodf/"+path;
            path = path.replace("../", "");
            runtime.log(path);
        }
...
if(String(typeof require) !== "undefined"){
    ...
    global.document = new JSDOM("<html><body><div id='main'></div></body></html>").window.document;
    ...
    // }
    // new odf.OdfCanvas(document,init())

    let cavas=new odf.OdfContainer("word.odp",(container)=>{
        ...
        console.log(container.getContentElement());
